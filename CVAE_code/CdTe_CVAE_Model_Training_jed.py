...
# =============================================================================
path = "/home/jed/git/2025_Hackathon/" # Insert the path of training image "CdTe_Training_Image", this will be your working directory
...
print("Model saved in : ", path + image_file.strip(".tif") + '_Size{}_Sigma{}_epochs{}_latentdim{}.keras'.format(SIZE, SIGMA, epochs, latent_dim))
