...
def get_testing_training_sets(image='STO_Training_Image.tif', size=180, n_images=20):
...
SIGMA = 1.4 # Set the Gaussian Blurring sigma value
epochs = 300  # Number of epochs on which to train the CVAE 
latent_dim = 20  # Latent dimensions of the CVAE 

im=Image.open("STO_Training_Image.jpg").convert("L")
print(np.array(im).shape)
im.save('STO_Training_Image_L.tif')

image_file = "STO_Training_Image_L.tif" #Image file used to obtain the training sets
# =============================================================================
